    ...
    return (
        ...
        <View style={{ flex: 1, }}>
            ...
            <View style={{ justifyContent: 'space-between', flex: 9 }}>
                {!(props.screenType === 'form') ? <View style={[styles.screenMargin, props.nopadding && styles.noPadding, props.row && { flex:1,flexDirection: 'row' }]}>{props.children}</View> : props.children}
            </View >
        </View >
