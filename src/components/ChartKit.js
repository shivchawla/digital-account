...
const ChartKit = (props) => {
    ...
    return (
        <View style={{ flex: 1, padding: 0, }}>
            <LineChart data={data}
                width={Layout.window.width - 40} height={Layout.window.height > 570 ? 180 : 170} yAxisLabel={""} yAxisSuffix={""} fromZero={false} onDataPointClick={val => props.dataPointClicked(val)}// from react-native 
                chartConfig={{
                    fontSize: 5,
