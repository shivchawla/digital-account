                            ...
                            <View style={[{ flex: 9 }]}>
                                ...
                                <ScrollView style={[styles.screenMargin]}>
                                    ...
                                    <View style={[styles.formElement, { marginTop: 20 }]}>
                                        <Text style={[styles.titleBox, { marginBottom: 5 }]}>Bank Account Number</Text>
                                    ...
                                    <View style={[styles.formElement]}>
                                        <Text style={[styles.titleBox, { marginBottom: 5 }]}>Bank Account Name</Text>
                                    ...
                                    <View style={[styles.formElement]}>
                                        <Text style={[styles.titleBox, { marginBottom: 5 }]}>Bank Label</Text>
                                        <TextInput value={bankLabel} onChangeText={FormikProps.handleChange('bankLabel')} onBlur={FormikProps.handleBlur('bankLabel')} style={{ borderWidth: 1, borderColor: bankLabelTouched && bankLabelError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }} placeholder={bankLabelTouched && bankLabelError ? '' : 'Eg: For reference'} placeholderTextColor={bankLabelTouched && bankLabelError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
