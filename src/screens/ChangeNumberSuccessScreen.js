...
const ChangeNumberSuccessScreen = (props) => {
        ...
        <View style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, }}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ flex: 2, alignSelf: 'stretch' }}>
                    <Image source={require('../assets/images/phonesuccess.png')} style={{ flex: 1, height: undefined, width: undefined }} resizeMode={'contain'} />
                </View>
                <View style={{ flex: 1, alignItems: 'center' }}>
                    <Text style={[styles.h3, { margin: 5, fontWeight: 'bold',fontSize:17 }]}>Phone Number Changed!</Text>
                    <View style={{ alignSelf: 'stretch', flexDirection: 'column', margin: 5, alignItems: 'center' }}>
                        ...
                        <Text style={[styles.text, { margin: 5, marginBottom: 20, textAlign: 'center' }]}>Your phone number has been successfully updated.</Text>
                    </View>
                </View>
                <View style={{ flex: 1 }}>
...
export default ChangeNumberSuccessScreen 