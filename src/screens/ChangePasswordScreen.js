                        ...
                        <View style={{ justifyContent: 'space-between', flex: 9 }}>
                            <View style={[styles.screenMargin, { flex: 3 }]}>
                                ...
                                <View style={[styles.formElement]}>
                                    ...
                                    {newPasswordError && newPasswordTouched ?<Text style={styles.error}>{newPasswordError}</Text>:<Text style={{fontSize:10.5,fontFamily:'Montserrat_medium',color:'grey'}}>Password must be atleast 6 characters long</Text>}
                                </View>
                                <View style={[styles.formElement]}>
