            ...
            <View style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, }}>
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: Layout.window.width * 0.85, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Image source={require('../assets/images/merchantsuccess.png')} style={{ height: Layout.window.height * 0.3, width: Layout.window.width * 0.7 }} resizeMode={'contain'} />
                        <Text style={[styles.h3, { margin: 5, fontWeight: 'bold' }]}>Merchant Info Submitted</Text>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <TouchableOpacity onPress={() => props.navigation.navigate('ContactPerson')} style={{ width: Layout.window.width * 0.3, paddingTop: 5, paddingBottom: 5, borderRadius: 15, justifyContent: 'center', alignItems: 'center', margin: 10, backgroundColor: '#09A4BF' }}>
                                <Text style={[styles.textDefault, { color: 'white' }]}>Contact</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
