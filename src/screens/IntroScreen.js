        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={{ justifyContent: 'space-between', flex: 9 }}>
                ...
                <View style={{ flex: 9, margin: 10 }}>
                    ...
                    <ImageSlider style={{ flex: 10, alignSelf: 'stretch', backgroundColor: 'transparent' }} loopBothSides autoPlayWithInterval={1500} images={images} customSlide={({ index, item, style }) => (item &&
