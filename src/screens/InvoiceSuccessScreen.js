            ...
            <View style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{ width: Layout.window.width * 0.8, justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={[styles.text, { margin: 5, fontWeight: 'bold' }]}>New Invoice Created</Text>
                        ...
                        <View style={{ alignSelf: 'stretch', flexDirection: 'column', margin: 5,alignItems:'center' }}>
                            ...
                            <Text style={[styles.text, { margin: 5, marginBottom: 20 }]}>You have created a new invoice. The invoice will be sent to you.</Text>
                        </View>                       
...
InvoiceSuccessScreen.navigationOptions = { header: null, };
