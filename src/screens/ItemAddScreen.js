                        ...
                        <View style={{ justifyContent: 'space-between', flex: 9 }}>
                            <ScrollView style={[styles.screenMargin, { flex: 3 }]}>
                                <View style={[styles.formElement]}>
                                    ...
                                    <TextInput value={name} onChangeText={FormikProps.handleChange('name')} onBlur={FormikProps.handleBlur('name')} style={[styles.textInput,{ borderWidth: 1, borderColor: nameTouched && nameError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={nameTouched && nameError ? '' : 'Ubat Gigi Sunshine'} placeholderTextColor={nameTouched && nameError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                ...
                                <View style={{ marginBottom: 10 }}>
                                    ...
                                    <TextInput value={sku} onChangeText={FormikProps.handleChange('sku')} onBlur={FormikProps.handleBlur('sku')} style={[styles.textInput,{ borderWidth: 1, borderColor: skuTouched && skuError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={skuTouched && skuError ? '' : 'JJF-TS-GN'} placeholderTextColor={skuTouched && skuError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                    {skuTouched && skuError && <Text style={styles.error}>{skuError}</Text>}
                                </View>
                                <View style={[styles.formElement]}>
                                    <Text style={[styles.titleBox, { marginBottom: 5 }]}>Description</Text>
                                    <TextInput value={description} onChangeText={FormikProps.handleChange('description')} onBlur={FormikProps.handleBlur('description')} style={[styles.textInput,{ borderWidth: 1, borderColor: descriptionTouched && descriptionError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={descriptionTouched && descriptionError ? '' : 'Toothpaste 100ml'} placeholderTextColor={descriptionTouched && descriptionError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                ...
                                <View style={[styles.formElement]}>
                                    ...
                                    <TextInput value={sale_price} onChangeText={FormikProps.handleChange('sale_price')} onBlur={FormikProps.handleBlur('sale_price')} style={[styles.textInput,{ borderWidth: 1, borderColor: sale_priceTouched && sale_priceError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={sale_priceTouched && sale_priceError ? '' : 'RM10.00'} placeholderTextColor={sale_priceTouched && sale_priceError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'decimal-pad'} />
