                                        ...
                                        {iosItemPicker ? <View>
                                            <View style={[styles.formElement]}>
                                                ...
                                                <View style={[styles.formElement]}>
                                                    ...
                                                    <TextInput value={item} onChangeText={FormikProps.handleChange('item')} onBlur={FormikProps.handleBlur('item')} style={[styles.textInput,{ borderWidth: 1, borderColor: itemTouched && itemError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={itemTouched && itemError ? '' : ''} placeholderTextColor={itemTouched && itemError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                                ...
                                                <View style={[styles.formElement]}>
                                                    ...
                                                    <View style={{ flexDirection: 'row', alignSelf: 'stretch', }}>
                                                        ...
                                                        <TextInput value={priceItem} onChangeText={FormikProps.handleChange('priceItem')} onBlur={FormikProps.handleBlur('priceItem')} style={[styles.textInput,{ alignSelf: 'stretch', flex: 8, borderWidth: 1, borderColor: priceItemTouched && priceItemError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={priceItemTouched && priceItemError ? '' : ''} placeholderTextColor={priceItemTouched && priceItemError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'decimal-pad'} />
                                                    </View>
