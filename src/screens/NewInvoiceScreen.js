                                ...
                                <ScrollView style={[styles.screenMargin]}>
                                    ...
                                    <View style={[styles.formElement]}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                            ...
                                            <TextInput style={{ flex: 1, borderWidth: 1, borderColor: 'rgba(0,0,0,0.3)', marginLeft: 15 }} value={issueDate} />
                                        </View>
                                    ...
                                    <View style={[styles.formElement]}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                            ...
                                            <TextInput style={{ flex: 1, borderWidth: 1, borderColor: 'rgba(0,0,0,0.3)', marginLeft: 15 }} value={dueDate} />
                                        </View>
