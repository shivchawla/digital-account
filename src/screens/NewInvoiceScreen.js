                                    ...
                                    {invoice &&
                                        <View>
                                            ...
                                            <View style={[styles.formElement]}>
                                                ...
                                                <TextInput value={entityName} onChangeText={FormikProps.handleChange('entityName')} onBlur={FormikProps.handleBlur('entityName')} style={[styles.textInput,{ borderWidth: 1, borderColor: entityNameTouched && entityNameError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={entityNameTouched && entityNameError ? '' : 'Eg:Iskandar bin Abdullah'} placeholderTextColor={entityNameTouched && entityNameError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
