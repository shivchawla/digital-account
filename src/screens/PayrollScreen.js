                            ...
                            <View style={{ flex: 9 }}>
                                <ScrollView style={styles.screenMargin}>
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={personName} onChangeText={FormikProps.handleChange('personName')} onBlur={FormikProps.handleBlur('personName')} style={[styles.textInput,{ borderWidth: 1, borderColor: personNameTouched && personNameError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={personNameTouched && personNameError ? '' : 'Salman bin Abu Bakar'} placeholderTextColor={personNameTouched && personNameError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                    ...
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={accountNumber} onChangeText={FormikProps.handleChange('accountNumber')} onBlur={FormikProps.handleBlur('accountNumber')} style={[styles.textInput,{ borderWidth: 1, borderColor: accountNumberTouched && accountNumberError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={accountNumberTouched && accountNumberError ? '' : '789083821235'} placeholderTextColor={accountNumberTouched && accountNumberError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
                                    ...
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={amount} onChangeText={FormikProps.handleChange('amount')} onBlur={FormikProps.handleBlur('amount')} style={[styles.textInput,{ textAlignVertical: 'center', borderWidth: 1, borderColor: amountTouched && amountError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={amountTouched && amountError ? '' : 'RM 78.00'} placeholderTextColor={amountTouched && amountError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
                                    ...
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={deductionAmount} onChangeText={FormikProps.handleChange('deductionAmount')} onBlur={FormikProps.handleBlur('deductionAmount')} style={[styles.textInput,{ textAlignVertical: 'center', borderWidth: 1, borderColor: deductionAmountTouched && deductionAmountError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={deductionAmountTouched && deductionAmountError ? '' : 'address@email.com'} placeholderTextColor={deductionAmountTouched && deductionAmountError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
                                    ...
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={allowanceAmount} onChangeText={FormikProps.handleChange('allowanceAmount')} onBlur={FormikProps.handleBlur('allowanceAmount')} style={[styles.textInput,{ textAlignVertical: 'center', borderWidth: 1, borderColor: allowanceAmountTouched && allowanceAmountError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={allowanceAmountTouched && allowanceAmountError ? '' : 'RM 900.00'} placeholderTextColor={allowanceAmountTouched && allowanceAmountError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
