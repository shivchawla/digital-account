                            ...
                            <View style={{ flex: 9 }}>
                                <ScrollView style={styles.screenMargin}>
                                    ...
                                    <View style={styles.formElement}>
                                        ...
                                        <TextInput value={recipientName} onChangeText={FormikProps.handleChange('recipientName')} onBlur={FormikProps.handleBlur('recipientName')} style={[styles.textInput,{ borderWidth: 1, borderColor: recipientNameTouched && recipientNameError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={recipientNameTouched && recipientNameError ? '' : 'Siti Aminah binti Wahid'} placeholderTextColor={recipientNameTouched && recipientNameError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
