            ...
            {FormikProps => {
                ...
                return (
                    ...
                    <KeyboardAvoidingView behavior="padding" enabled style={{ flex: 1, }}>
                        <View style={{ flex: 1, flexDirection: 'row', borderBottomWidth: 1, borderColor: 'rgba(163, 0, 0, 0.5)', marginBottom: 25 }}>
                            ...
                            <View style={{ flex: 3, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={[styles.title, { color: '#A30000' }]}>Remittance Details</Text>
                            </View>
                                ...
                                <ScrollView style={styles.screenMargin}>
                                    <View style={[styles.formElement, { alignSelf: 'stretch' }]}>
                                        ...
                                        <View style={{ alignSelf: 'stretch', borderWidth: 1, borderColor: 'rgba(0,0,0,0.3)', marginBottom: 10 }}>
                                            <Picker style={{ flex: 1, height: 35, borderColor: '#A30000', borderWidth: 1 }} selectedValue={senderCurrency} onValueChange={(itemValue, itemIndex) => FormikProps.setFieldValue('senderCurrency', itemValue)}>
                                    ...
                                    <View style={[styles.formElement, { alignSelf: 'stretch' }]}>
                                        ...
                                        <View style={{ alignSelf: 'stretch', borderWidth: 1, borderColor: 'rgba(0,0,0,0.3)', marginBottom: 10 }}>
                                            <Picker style={{ flex: 1, height: 35, borderColor: '#A30000', borderWidth: 1 }} selectedValue={recipientCurrency} onValueChange={(itemValue, itemIndex) => FormikProps.setFieldValue('recipientCurrency', itemValue)}>
                                                <Picker.Item label={'Please Select'} value={undefined} />
                                                <Picker.Item label="Malaysian Ringgit (MYR)" value="myr" />
                                                <Picker.Item label="Indonesian Rupiah (IDR)" value="idr" />
                                            </Picker>
