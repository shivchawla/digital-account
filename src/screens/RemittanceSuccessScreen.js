        ...
        <View style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, }}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ flex: 2, alignSelf: 'stretch' }}>
                    <Image source={require('../assets/images/remittancesuccess.png')} style={{ flex: 1, height: undefined, width: undefined }} resizeMode={'contain'} />
                </View>
                <View style={{ flex: 1, alignItems: 'center' }}>
                    <Text style={[styles.h3, { margin: 5, fontWeight: 'bold',fontSize:17 }]}>Remittance Paid!</Text>
                    <View style={{ alignSelf: 'stretch', flexDirection: 'column', margin: 5, alignItems: 'center' }}>
                        ...
                        <Text style={[styles.text, { margin: 5, marginBottom: 20, textAlign: 'center' }]}>Proceed to pay remittance again or skip to the dashboard.</Text>
                    </View>
                </View>
                <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => props.navigation.navigate('Remittance')} style={{ width: Layout.window.width * 0.3, paddingTop: 16, paddingBottom: 16, borderRadius: 15, justifyContent: 'center', alignItems: 'center', margin: 10, backgroundColor: '#09A4BF' }}>
