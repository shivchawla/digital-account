                        ...
                        <View style={styles.box}>
                            ...
                            {item.marker && <View style={{ flex: 1 }}>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <Text style={[styles.text, { color: '#A30000' }]}>{item.credit_debit == 'DEBIT' ? 'to' : 'from'} {item.from_to}</Text>
                                    </View>
                                </View>
                                <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <Text style={[styles.text, { color: '#A30000' }]}>{item.amount.toFixed(2)}</Text>
                                    </View>
                                </View>
                                <View style={{ flexDirection: 'row', marginTop: 5 }}>
                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <Text style={[styles.text, { color: '#A30000' }]}>{item.status}</Text>
                                    </View>
                                </View>
                            </View>
                            }
