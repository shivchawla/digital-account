        ...
        <View style={{ flex: 1, }}>
            ...
            <View style={[styles.screenMargin, { flex: 8 }]}>
                <View style={{ marginBottom: 5, marginTop: 20 }}>
                    <Text style={[styles.h2, { color: '#DE4848' }]}>ACCOUNT</Text>
                </View>
            ...
            <View style={{ flexDirection: 'column', flex: 1, justifyContent: 'flex-end', alignItems: 'flex-end' }}>
                <Text style={[styles.small, { color: '#A30000' }]}>Digital Account v0.2</Text>
                <Text style={[styles.small, { color: '#A30000' }]}>{expo_token}</Text>
                {test_notification && <Text style={[styles.small, { color: '#A30000' }]}>{test_notification}</Text>}
            </View>
        </View>
    );
}
