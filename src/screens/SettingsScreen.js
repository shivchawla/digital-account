        ...
        <View style={{ flex: 1, }}>
            ...
            <View style={{ flex: 9, padding: 10 }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30}}>
                    ...
                    <Text style={[styles.text, { color: 'black', marginLeft: 50 }]}>Edit Profile</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30}}>
                    <Image
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30}}>
                    <Image
                        source={require('../assets/images/changeaccount.png')}
                        style={{ width: 30, height: 30, }} />
                    <Text style={[styles.text, { color: 'black', marginLeft: 50  }]}>Change Account</Text>
                </View>
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30}}>
                    <Image
                        source={require('../assets/images/changemobilenumber.png')}
                        style={{ width: 30, height: 30, }} />
