            ...
            <View style={{ flex: 8, padding: 10 }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30, alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={() => props.navigation.navigate('ChangePassword')}>
                        <Text style={[styles.text, { color: '#055E7C', marginLeft: 50 }]}>Change Password</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30, alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={() => props.navigation.navigate('ChangeEmail')}>
                        <Text style={[styles.text, { color: '#055E7C', marginLeft: 50 }]}>Change E-Mail Address</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30, alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={() => props.navigation.navigate('ChangeNumber')}>
                        <Text style={[styles.text, { color: '#055E7C', marginLeft: 50 }]}>Change Phone Number</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                    ...
                    <View style={{}}>
                        <Text style={[styles.h2, { color: '#055E7C' }]}>APP SETTING</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30, alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => props.navigation.navigate('NotiScreen')}>
                            <Text style={[styles.text, { color: '#055E7C', marginLeft: 50 }]}>Notification</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 30, alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => props.navigation.navigate('Support')}>
                            <Text style={[styles.text, { color: '#055E7C', marginLeft: 50 }]}>Support</Text>
                        </TouchableOpacity>
                    </View>
