                    ...
                    <KeyboardAvoidingView behavior="padding" enabled style={{ flex: 2 }}>
                        ...
                        <View style={{ justifyContent: 'space-between', flex: 9 }}>
                            <View style={{ flex: 9, margin: 10 }}>
                                <View style={{ alignSelf: 'center', borderBottomWidth: 1, borderBottomColor: nameTouched && nameError ? '#d94498' : '#5a83c2', flexDirection: 'row', margin: 5 }}>
                                ...
                                <View style={{ alignSelf: 'center', borderBottomWidth: 1, borderBottomColor: emailTouched && emailError ? '#d94498' : '#5a83c2', flexDirection: 'row', margin: 5 }}>
                                ...
                                <View style={{ alignSelf: 'center', borderBottomWidth: 1, borderBottomColor: passwordTouched && passwordError ? '#d94498' : '#5a83c2', flexDirection: 'row', margin: 5 }}>
                                ...
                                <View style={{ alignSelf: 'center', borderBottomWidth: 1, borderBottomColor: password_confirmationTouched && password_confirmationError ? '#d94498' : '#5a83c2', flexDirection: 'row', margin: 5, marginBottom: 20 }}>
                                    <Image source={require('../assets/images/password.png')} style={{ height: 30, width: 30, margin: 5 }} resizeMode={'contain'} />
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignSelf: 'stretch' }}>
                                ...
                                <TouchableOpacity disabled={!FormikProps.isValid} onPress={FormikProps.handleSubmit} style={{ flex: 1 }} >
                                    <LinearGradient colors={FormikProps.isValid ? ['#628BFB', '#0E47E8'] : ['rgba(77, 203, 62, 0.5)', 'rgba(38, 155, 29, 0.5)']} style={{ flex: 1, padding: 10, justifyContent: 'center', alignItems: 'center' }}>
