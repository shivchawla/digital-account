                                ...
                                <View style={styles.screenMargin}>
                                    ...
                                    <View style={[styles.formElement, { marginBottom: 10 }]}>
                                        <TouchableOpacity onPress={() => setuserListView(!userListView)}>
                                            ...
                                            <TextInput editable={false} value={recipient} style={[styles.textInput,{ borderWidth: 1, borderColor: 'rgba(0,0,0,0.3)', padding: 5,fontSize:17 }]} placeholder={recipientTouched && recipientError ? '' : '123456789'} placeholderTextColor={recipientTouched && recipientError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                        </TouchableOpacity>
