                        ...
                        <View style={{ justifyContent: 'space-between', flex: 9 }}>
                            <ScrollView style={[styles.screenMargin, { flex: 3 }]}>
                                <View style={[styles.formElement]}>
                                    ...
                                    <TextInput value={vendorName} onChangeText={FormikProps.handleChange('vendorName')} onBlur={FormikProps.handleBlur('vendorName')} style={[styles.textInput,{ borderWidth: 1, borderColor: vendorNameTouched && vendorNameError ? 'rgba(255,0,0,1)' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={vendorNameTouched && vendorNameError ? '' : 'Siti binti Ali'} placeholderTextColor={vendorNameTouched && vendorNameError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                ...
                                <View style={[styles.formElement]}>
                                    ...
                                    <TextInput value={vendorEmail} onChangeText={FormikProps.handleChange('vendorEmail')} onBlur={FormikProps.handleBlur('vendorEmail')} style={[styles.textInput,{ borderWidth: 1, borderColor: vendorEmailTouched && vendorEmailError ? 'rgba(255,0,0,1)' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={vendorEmailTouched && vendorEmailError ? '' : 'example@email.com'} placeholderTextColor={vendorEmailTouched && vendorEmailError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                ...
                                <View style={[styles.formElement]}>
                                    ...
                                    <TextInput value={address} onChangeText={FormikProps.handleChange('address')} onBlur={FormikProps.handleBlur('address')} style={[styles.textInput,{ borderWidth: 1, borderColor: addressTouched && addressError ? 'rgba(255,0,0,1)' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={addressTouched && addressError ? '' : '32, Jalan Hartamas, Bandar Baru Sendayan, Negeri Sembilan'} placeholderTextColor={addressTouched && addressError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
