                            ...
                            <View style={[styles.screenMargin, { flex: 9 }]}>
                                <ScrollView >
                                    ...
                                    <View style={[styles.formElement]}>
                                        ...
                                        <TextInput value={amountZakat} onChangeText={FormikProps.handleChange('amountZakat')} onBlur={FormikProps.handleBlur('amountZakat')} style={[styles.textInput,{ borderWidth: 1, borderColor: amountZakatTouched && amountZakatError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={amountZakatTouched && amountZakatError ? '' : 'RM 100.00'} placeholderTextColor={amountZakatTouched && amountZakatError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
                                    ...
                                    <View style={[styles.formElement]}>
                                        ...
                                        <TextInput value={payerEmail} onChangeText={FormikProps.handleChange('payerEmail')} onBlur={FormikProps.handleBlur('payerEmail')} style={[styles.textInput,{ textAlignVertical: 'center', borderWidth: 1, borderColor: payerEmailTouched && payerEmailError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={payerEmailTouched && payerEmailError ? '' : 'address@email.com'} placeholderTextColor={payerEmailTouched && payerEmailError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} />
                                    ...
                                    <View style={[styles.formElement]}>
                                        ...
                                        <TextInput value={payerPhoneNumber} onChangeText={FormikProps.handleChange('payerPhoneNumber')} onBlur={FormikProps.handleBlur('payerPhoneNumber')} style={[styles.textInput,{ textAlignVertical: 'center', borderWidth: 1, borderColor: payerPhoneNumberTouched && payerPhoneNumberError ? '#d94498' : 'rgba(0,0,0,0.3)', padding: 5 }]} placeholder={payerPhoneNumberTouched && payerPhoneNumberError ? '' : '0189076510'} placeholderTextColor={payerPhoneNumberTouched && payerPhoneNumberError ? 'rgba(255,0,0,0.3)' : 'lightgrey'} keyboardType={'phone-pad'} />
