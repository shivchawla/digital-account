...
const loanBillReducer = (state = [], action) => {
    switch (action.type) {
        case 'SET_LOAN_BILL_LIST':
            return { ...state, ...action.payload }
